...
c
        ...
        maxdepth=200
c        
        call adinrecp(ier,stack,a,b,fun,par1,par2,t,w,m,
...
c
c
        subroutine adinrecp(ier,stack,a,b,fun,
     1      par1,par2,t,w,m,vals,nnmax,eps,
     2      rint,maxdepth,maxrec,numint)
        implicit real *8 (a-h,o-z)
        dimension stack(2,*),t(*),w(*),vals(*),par1(*),par2(*)
c
c       start the recursion
c
        stack(1,1)=a
        stack(2,1)=b
        call oneintp(a,b,fun,par1,par2,t,w,m,vals(1))
c
...
c
        ...
        call oneintp(stack(1,j),c,fun,
     1      par1,par2,t,w,m,value2)
c
        call oneintp(c,stack(2,j),fun,
...
c
c
        subroutine oneintp(a,b,fun,par1,par2,t,w,m,rint)
        implicit real *8 (a-h,o-z)
        dimension t(*),w(*),par1(*),par2(*)
c
