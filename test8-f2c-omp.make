#
#  test8-f2c-omp.make -- build test8 via f2c + gcc with OpenMP
#
#  Usage:
#    make -f test8-f2c-omp.make
#    make -f test8-f2c-omp.make run
#    make -f test8-f2c-omp.make clean
#
...
FSRCS = test8.f chunkmatc.f inter2dn.f hank103.f cadavect.f \
