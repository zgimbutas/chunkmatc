#
#  test7-f2c-omp-float256.make -- build test7 via f2c + gcc with OpenMP +
#  float256 (REAL*32) precision
#
#  Usage:
#    make -f test7-f2c-omp-float256.make
#    make -f test7-f2c-omp-float256.make run
#    make -f test7-f2c-omp-float256.make clean
#

PROJECT = int2

F2C     = $(HOME)/linux/repositories/f2c/src/f2c
F2CFLAGS = -fomp -freal-8-real-32
...
CFLAGS  = -O3 -march=native -fopenmp -DF2C_FLOAT128 -DF2C_FLOAT256 $(GCC_STD) -I$(F2C_INC)
LDLIBS  = $(LIBF2C) $(MPFR_LIB) $(GMP_LIB) -lquadmath -lm -lgomp

SRCDIR   = .
LIBDIR   = $(HOME)/develop/lib
BUILDDIR = _f2c_build_omp_float256
