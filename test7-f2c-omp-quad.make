#
#  test7-f2c-omp-quad.make -- build test7 via f2c + gcc with OpenMP + quad precision
#
#  Usage:
#    make -f test7-f2c-omp-quad.make
#    make -f test7-f2c-omp-quad.make run
#    make -f test7-f2c-omp-quad.make clean
#

PROJECT = int2

F2C     = $(HOME)/linux/repositories/f2c/src/f2c
F2CFLAGS = -fomp -freal-8-real-16
...
CFLAGS  = -O3 -march=native -fopenmp -DF2C_FLOAT128 $(GCC_STD) -I$(F2C_INC)
LDLIBS   = $(LIBF2C) $(MPFR_LIB) $(GMP_LIB) -lquadmath -lm -lgomp

SRCDIR   = .
LIBDIR   = $(HOME)/develop/lib
BUILDDIR = _f2c_build_omp_quad
